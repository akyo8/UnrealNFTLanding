      ...
      <div className="flex justify-center items-center">
        <div className="w-3/3  rounded-lg shadow-sm p-8">
          <div className="flex justify-between items-center">
            ...
            <button className="hover:bg-blue-50 p-2 rounded-sm"></button>
          </div>
              ...
              <div className="flex justify-start items-center gap-2">
                ...
                <div>
                  <p className="text-gray-700 font-bold tracking-wider">
                    Wallet Address:{props.children.account}
                  </p>
                  <p className="text-yellow-700 font-bold tracking-wider">
                    Balance : {props.children.balance} ETH
                  </p>
                </div>
              </div>
            </div>
