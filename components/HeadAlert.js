    ...
    <div>
      <div className=" container absolutepy-4 p-10 justify-center items-center">
        {props.children.account ? (
          <div classNameName="w-6/3 bg-blue-100 rounded-lg shadow-sm p-5 border-dashed border border-blue-500 flex flex-col sm:flex-row justify-between items-center gap-2 sm:gap-0">
          ...
          <div className="flex flex-col p-8 bg-white shadow-md hover:shodow-lg rounded-2xl">
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                <svg
                  className="w-16 h-16 rounded-2xl p-3 border border-gray-100 text-yellow-400 bg-gray-800"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                >
                ...
                <div className="flex flex-col ml-3">
                  ...
                  <p className="text-lg text-gray-600 leading-none mt-1">
                    {" "}
                    {props.children.createdNumber}
                  </p>
                </div>
              </div>
            </div>
