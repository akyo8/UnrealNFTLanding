        ...
        <>
          ...
          <div className="flex justify-center p-2 m-3">
            <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-5 xl:grid-cols-5 gap-2 pt-1">
              <NewImageHead>
                {{
                  image: firstOne.image,
                  price: firstOne.price,
                  description: firstOne.description,
                  buy: async () => {
                    buyNFT(firstOne);
                  },
                }}
              ...
              <NewImageHead>
                {{
                  image: seconsOne.image,
                  price: seconsOne.price,
                  description: seconsOne.description,
                  buy: async () => {
                    buyNFT(seconsOne);
                  },
                }}
              ...
              <NewImageHead>
                {{
                  image: thirdOne.image,
                  price: thirdOne.price,
                  description: thirdOne.description,
                  buy: async () => {
                    buyNFT(thirdOne);
                  },
                }}
              ...
              <NewImageHead>
                {{
                  image: fourthOne.image,
                  price: fourthOne.price,
                  description: fourthOne.description,
                  buy: async () => {
                    buyNFT(fourthOne);
                  },
                }}
              ...
              <NewImageHead>
                {{
                  image: fivthOne.image,
                  price: fivthOne.price,
                  description: fivthOne.description,
                  buy: async () => {
                    buyNFT(fivthOne);
                  },
                }}
                          ...
                          <div className="w-80 mt-24 m-auto lg:mt-16 max-w-sm">
                            ...
                            <div className="bg-white shadow-2xl rounded-b-3xl">
                              ...
                              <div className="bg-gray-800 w-72 lg:w-5/6 m-auto mt-6 p-2 hover:bg-yellow-500 rounded-2xl  text-white text-center shadow-xl shadow-bg-blue-700">
                                <button
                                  classNames="lg:text-sm text-lg font-bold"
                                  onClick={() => buyNFT(item)}
                                >
                                  Proceed to Buy
                                </button>
                              </div>
                              <div className="text-center m-auto mt-6 w-full h-1"></div>
                            </div>
                          </div>
                        </div>
                      </div>
